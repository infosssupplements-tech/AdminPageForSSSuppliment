"""
Django Admin: NOT USED

This project uses MongoDB for all data storage.
Django admin panel is not used since we're using MongoDB only.

All admin functionality is handled through the custom API endpoints.
"""
